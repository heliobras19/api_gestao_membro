...
class Membro extends Model
{
    ...
    protected $fillable = ['nome', 'email', 'telefone', 'sexo', 'data_nascimento', 'municipio','comuna_id',
        ...
        'natural_de', 'nivel_academico', 'partido_anterior', 'is_quadro', 'data_emissao_bi', 'numero_cart_membro', 'formacoes_politicas', 'data_emis_cart_municipe', 'data_emissao_cart_membro', 'onde_combateu'];
